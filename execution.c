...
/**
 * command_manager - responsible for managing the process that a command goes through
 * @args: command and its arguments
 *
 * Return: TRUE if the process is successful, FALSE if it encounters failure
 */
 ...
 * @args: command and its associated arguments
 * Return: SKIP_FORK if its a built n function, DO_EXECVE if its not built in
 * exit shell, EXIT_SHELL_CODE if exiting with a specific code
 */
...
/**
 * and_or - handles logical operators in the command line
 * @args: command and its associated arguments
 * @operator: first character of the logical operator
 * @last_compare: indicates whether the last command in the logic evaluation was  true or false
 *
 * Return: indicates whether this command evaluates to true or false
 */
...
/**
 * check_command - verifies the existence of a non-built-in command
 * @args: arguments and commands
 *
